...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedWasteItems() {
        ...
        wasteItemRepository.save(WasteItem.builder().name("Glass Jar").category("RECYCLABLE").icon("🫙").disposalInstructions("Rinse clean. Remove metal lids. Place in glass recycling bin.").tips("Glass is 100% recyclable forever!").recyclable(true).binColor("blue").build());
        ...
        wasteItemRepository.save(WasteItem.builder().name("Aluminum Can").category("RECYCLABLE").icon("🥫").disposalInstructions("Rinse and crush. Place in metal recycling bin.").tips("Recycling aluminum uses 95% less energy!").recyclable(true).binColor("blue").build());
        ...
        wasteItemRepository.save(WasteItem.builder().name("Egg Carton").category("ORGANIC").icon("🥚").disposalInstructions("Cardboard cartons go in paper recycling.").tips("Cardboard egg cartons are great for seedling starters!").recyclable(true).binColor("green").build());
